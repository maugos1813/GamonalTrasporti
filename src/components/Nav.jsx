        ...
        <div className="flex justify-between items-center h-full">
          <div className="flex items-center ">
            <img
              src={logom}
              alt="medicine icon"
              className="h-[8vh] rounded-full p-2"
            />
          </div>
          ...
          <div className="hidden lg:flex flex-grow justify-center items-center space-x-4">
            <Link
              to="/"
              className="text-white hover:text-gray-900 text-[2vh] hover:bg-green-500 w-[10vh] flex justify-center rounded-md"
            >
              Home
            </Link>
            <Link
            ...
            <ul className="flex flex-col bg-[#252d5c] text-white w-full">
              <li className="shadow-lg rounded-xl">
                <Link
                  ...
                  className="block px-4 py-2 text-white hover:text-gray-900 border-green-300 "
                >
                  Home
                </Link>
              </li>
              <li className="shadow-lg rounded-xl">
                <Link
                  to="/services"
                  onClick={handleLinkClick}
                  className="block px-4 py-2 text-white hover:text-gray-900"
                >
                  Servizi
                </Link>
              </li>
