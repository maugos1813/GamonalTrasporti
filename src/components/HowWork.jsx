...
export const HowWork = () => {
  return (
    <div className="bg-gray-100">
      ...
      <div className="lg:flex lg:gap-10 lg:pb-[100px]">
        <div className="flex items-center justify-center lg:items-start lg:justify-start">
          <img
            src={entregando}
            alt="giving a packet image"
            className="w-[90vw] rounded-3xl md:w-[50vw] lg:w-[45vw] lg:ml-10"
          />
        </div>

        <div className="flex flex-col items-center justify-center mt-[80px] pb-[80px] gap-16 lg:mt-[0px] lg:justify-center lg:items-center">
          <div className="flex w-[80vw] gap-8 lg:w-[35vw]">
            <div>
              <img
                src={temp}
                alt="temperature icon"
                className="w-[15vw] lg:w-[10vw]"
              />
            </div>
            <div className="">
